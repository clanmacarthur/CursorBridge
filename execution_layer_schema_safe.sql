-- ============================================================
-- EXECUTION LAYER SCHEMA (SAFE VERSION)
-- CursorBridge: Tables for session generation & runtime
-- Run this after: evidence_techniques_schema.sql
-- ============================================================
...
-- 5. CUE TRIGGERS (no foreign keys to avoid dependency issues)
...
-- 6. SESSION BLUEPRINTS (simple - no FK constraints)
...
-- 7. TECHNIQUE STEPS (simple - no FK constraints for now)
...
('Phase Start Ritual', 'phase_start', NULL, 'Beginning this phase with presence and intention...', 'Proves full array works'),
...
('Breath Ladder: Box to Fire to NSDR', 'Progressive breath journey from calm to activation to deep rest', 'baseline', true, true, 10, ARRAY['breathwork', 'regulation', 'nsdr'], 'Good demo - shows full system'),
...
('Athlete Downshift: CO2 Tolerance to Soft Stretch', 'Recovery-focused session for athletes', 'baseline', true, true, 40, ARRAY['athlete', 'recovery', 'performance'], 'Recovery-centric framing'),
...
('physiology_plain', 'Physiology (Plain)', 'perspective', 'scientific', 'neutral', 'Explain what is happening in the body in simple terms', '🫁', 20),
