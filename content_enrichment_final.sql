-- ============================================================
-- CONTENT ENRICHMENT FINAL: Correct column names verified
...
INSERT INTO techniques (technique, technique_category, objective, default_duration_min, intensity_band, contraindications_summary, lens_explanation_western, lens_explanation_tcm)
SELECT 'Box Breathing', 'breathwork', 'Equal inhale, hold, exhale, hold pattern for nervous system regulation', 5, 'low', 'Safe for most users. Stop if dizzy.', 
...
WHERE NOT EXISTS (SELECT 1 FROM techniques WHERE technique = 'Box Breathing');

INSERT INTO techniques (technique, technique_category, objective, default_duration_min, intensity_band, contraindications_summary, lens_explanation_western, lens_explanation_tcm)
SELECT 'Wim Hof Breathing', 'breathwork', 'Cyclic hyperventilation followed by breath retention for stress resilience', 10, 'high', 'Not for pregnant, cardiovascular issues, or epilepsy. Practice seated/lying.',
...
WHERE NOT EXISTS (SELECT 1 FROM techniques WHERE technique = 'Wim Hof Breathing');

INSERT INTO techniques (technique, technique_category, objective, default_duration_min, intensity_band, contraindications_summary, lens_explanation_western, lens_explanation_tcm)
SELECT 'Physiological Sigh', 'breathwork', 'Double inhale through nose, long exhale for rapid calm', 2, 'low', 'Safe for all. Can use anytime.',
...
WHERE NOT EXISTS (SELECT 1 FROM techniques WHERE technique = 'Physiological Sigh');

INSERT INTO techniques (technique, technique_category, objective, default_duration_min, intensity_band, contraindications_summary, lens_explanation_western, lens_explanation_tcm)
SELECT 'Alternate Nostril Breathing', 'breathwork', 'Alternating breath through left and right nostrils for balance', 8, 'low', 'Safe for most. Avoid with severe congestion.',
...
WHERE NOT EXISTS (SELECT 1 FROM techniques WHERE technique = 'Alternate Nostril Breathing');

INSERT INTO techniques (technique, technique_category, objective, default_duration_min, intensity_band, contraindications_summary, lens_explanation_western, lens_explanation_tcm)
SELECT 'Inner Smile Meditation', 'meditation', 'Taoist practice of directing loving awareness to internal organs', 10, 'low', 'Safe for all. Gentle practice.',
...
WHERE NOT EXISTS (SELECT 1 FROM techniques WHERE technique = 'Inner Smile Meditation');

INSERT INTO techniques (technique, technique_category, objective, default_duration_min, intensity_band, contraindications_summary, lens_explanation_western, lens_explanation_tcm)
SELECT 'Six Healing Sounds', 'breathwork', 'Mantak Chia practice pairing sounds with organ healing', 15, 'low', 'Safe for all. Practice gently.',
...
WHERE NOT EXISTS (SELECT 1 FROM techniques WHERE technique = 'Six Healing Sounds');

INSERT INTO techniques (technique, technique_category, objective, default_duration_min, intensity_band, contraindications_summary, lens_explanation_western, lens_explanation_tcm)
SELECT 'Body Scan Meditation', 'meditation', 'Progressive attention through body regions for somatic awareness', 15, 'low', 'Safe for all. Modify for trauma history.',
...
WHERE NOT EXISTS (SELECT 1 FROM techniques WHERE technique = 'Body Scan Meditation');

INSERT INTO techniques (technique, technique_category, objective, default_duration_min, intensity_band, contraindications_summary, lens_explanation_western, lens_explanation_tcm)
SELECT 'Microcosmic Orbit', 'meditation', 'Circulating energy through Governing and Conception vessels', 20, 'medium', 'Practice gently. Stop if uncomfortable.',
...
WHERE NOT EXISTS (SELECT 1 FROM techniques WHERE technique = 'Microcosmic Orbit');

INSERT INTO techniques (technique, technique_category, objective, default_duration_min, intensity_band, contraindications_summary, lens_explanation_western, lens_explanation_tcm)
SELECT 'Grounding Visualization', 'meditation', 'Imagining roots growing from body into earth', 5, 'low', 'Safe for all. Good for anxiety.',
...
WHERE NOT EXISTS (SELECT 1 FROM techniques WHERE technique = 'Grounding Visualization');

INSERT INTO techniques (technique, technique_category, objective, default_duration_min, intensity_band, contraindications_summary, lens_explanation_western, lens_explanation_tcm)
SELECT 'Gentle Spinal Waves', 'movement', 'Undulating movement through the spine for flexibility and release', 8, 'low', 'Move slowly. Stop if pain.',
...
WHERE NOT EXISTS (SELECT 1 FROM techniques WHERE technique = 'Gentle Spinal Waves');
...
-- ============================================================
-- 5. ADDITIONAL LENSES (correct columns)
-- ============================================================
...
-- ============================================================
-- 6. MORE KNOWLEDGE BASES (correct columns: kb_description)
-- ============================================================

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'greek_philosophy', 'Greek Philosophy', 'Stoics, Epicureans, Plato, Aristotle on wellbeing', 'literature', 'philosophical', 'greek', true, true, '🏛️', 30
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'greek_philosophy');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'celtic_wisdom', 'Celtic/Druidic Wisdom', 'Nature cycles, tree lore, seasonal practices', 'literature', 'traditional', 'celtic', true, true, '🌳', 31
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'celtic_wisdom');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'egyptian_mysteries', 'Egyptian Mysteries', 'Book of the Dead, Emerald Tablets, hermetic wisdom', 'literature', 'mystical', 'egyptian', true, true, '👁️', 32
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'egyptian_mysteries');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'norse_mythology', 'Norse Mythology', 'Eddas, runes, Norse cosmology', 'literature', 'traditional', 'norse', true, true, '⚡', 33
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'norse_mythology');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'kabbalah', 'Kabbalah/Jewish Mysticism', 'Tree of Life, Sefirot, mystical Judaism', 'literature', 'mystical', 'jewish', true, true, '✡️', 34
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'kabbalah');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'christian_mystics', 'Christian Mysticism', 'Desert Fathers, Meister Eckhart, contemplative Christianity', 'literature', 'mystical', 'christian', true, true, '✝️', 35
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'christian_mystics');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'shamanic_traditions', 'Shamanic Traditions', 'Indigenous healing practices from various cultures', 'literature', 'traditional', 'indigenous', true, true, '🦅', 36
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'shamanic_traditions');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'astrology_systems', 'Astrological Systems', 'Western, Vedic, Chinese astrology frameworks', 'reference', 'traditional', 'various', true, true, '⭐', 40
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'astrology_systems');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'tarot_arcana', 'Tarot Arcana', 'Major and Minor Arcana meanings and interpretations', 'reference', 'esoteric', 'western', true, true, '🃏', 41
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'tarot_arcana');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'i_ching', 'I Ching', 'Book of Changes, hexagrams, Chinese divination wisdom', 'literature', 'traditional', 'chinese', true, true, '☰', 42
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'i_ching');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'mythology_world', 'World Mythology', 'Comparative mythology across cultures', 'literature', 'traditional', 'universal', true, true, '🌍', 43
WHERE NOT EXISTS (SELECT 1 FROM knowledge_bases WHERE kb_slug = 'mythology_world');

INSERT INTO knowledge_bases (kb_slug, kb_name, kb_description, kb_type, paradigm_family, cultural_origin, is_system, is_active, icon, sort_order)
SELECT 'fairy_tales', 'Fairy Tales and Folklore', 'Archetypal stories, Jungian interpretations', 'literature', 'traditional', 'universal', true, true, '📖', 44
