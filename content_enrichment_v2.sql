-- ============================================================
-- CONTENT ENRICHMENT V2: Using correct column names
-- Run in Supabase SQL Editor
-- ============================================================

-- ============================================================
-- 1. MORE TECHNIQUES (correct columns)
-- ============================================================
...
INSERT INTO knowledge_bases (kb_slug, kb_name, kb_type, description, source_tradition, requires_permission, is_active, icon, sort_order)
SELECT 'egyptian_mysteries', 'Egyptian Mysteries', 'literature', 'Book of the Dead, Emerald Tablets, hermetic wisdom', 'Egyptian', false, true, '👁️', 32
...
INSERT INTO knowledge_bases (kb_slug, kb_name, kb_type, description, source_tradition, requires_permission, is_active, icon, sort_order)
SELECT 'fairy_tales', 'Fairy Tales and Folklore', 'literature', 'Archetypal stories, Jungian interpretations', 'Universal', false, true, '📖', 44
