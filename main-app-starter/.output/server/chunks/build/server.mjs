import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};globalThis.__timing__.logStart('Load chunks/build/server');import { hasInjectionContext, inject, getCurrentInstance, toRef, isRef, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { n as createError$1, q as parseURL, v as encodePath, w as decodePath, x as hasProtocol, y as isScriptProtocol, p as joinURL, z as withQuery, A as sanitizeStatusCode, B as getContext, $ as $fetch, C as createHooks, D as defu, E as executeAsync, i as getHeader, F as createDebugger, h as setCookie, G as klona, H as parse, I as getRequestHeader, d as destr, J as getCookie, K as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cypi4kPH.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-D-uqV1t7.mjs')
  },
  {
    name: "session",
    path: "/session",
    component: () => import('./session-BKBrTJsE.mjs')
  },
  {
    name: "sessions",
    path: "/sessions",
    component: () => import('./sessions-DVIe3zP1.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-BsLQX4uI.mjs')
  },
  {
    name: "sessions-composer-prototype",
    path: "/sessions-composer-prototype",
    component: () => import('./sessions-composer-prototype-D7CAlWye.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D9EsUI2h.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BBZfpSji.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CRxYV1yZ.mjs'));
...
export { _export_sfc as _, useRoute as a, useNuxtApp as b, asyncDataDefaults as c, useRequestFetch as d, createError as e, fetchDefaults as f, useRouter as g, encodeRoutePath as h, useRuntimeConfig as i, nuxtLinkDefaults as j, server as k, navigateTo as n, resolveRouteObject as r, serialize as s, tryUseNuxtApp as t, useSupabaseUser as u };;globalThis.__timing__.logEnd('Load chunks/build/server');
