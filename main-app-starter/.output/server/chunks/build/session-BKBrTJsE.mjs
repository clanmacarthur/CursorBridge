globalThis.__timing__.logStart('Load chunks/build/session-BKBrTJsE');import { defineComponent, ref, mergeProps, unref, computed, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderComponent, ssrRenderStyle } from 'vue/server-renderer';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "session-player" }, _attrs))} data-v-45f1cbac><div class="player-header" data-v-45f1cbac><h1 data-v-45f1cbac>${ssrInterpolate(__props.session.name)}</h1><p class="persona" data-v-45f1cbac>${ssrInterpolate(__props.session.persona_style)}</p></div><div class="progress-bar" data-v-45f1cbac><div class="progress-fill" style="${ssrRenderStyle({ width: unref(progressPercent) + "%" })}" data-v-45f1cbac></div></div><div class="time-display" data-v-45f1cbac><span data-v-45f1cbac>${ssrInterpolate(formatTime(unref(elapsedSeconds)))}</span><span data-v-45f1cbac>${ssrInterpolate(formatTime(unref(totalSeconds)))}</span></div><div class="current-section" data-v-45f1cbac><div class="${ssrRenderClass([(_a = unref(currentSection)) == null ? void 0 : _a.type, "section-type"])}" data-v-45f1cbac>${ssrInterpolate((_b = unref(currentSection)) == null ? void 0 : _b.type)}</div><h2 data-v-45f1cbac>${ssrInterpolate((_c = unref(currentSection)) == null ? void 0 : _c.name)}</h2><p class="instructions" data-v-45f1cbac>${ssrInterpolate((_d = unref(currentSection)) == null ? void 0 : _d.instructions)}</p>`);
      if ((_e = unref(currentSection)) == null ? void 0 : _e.cues) {
      ...
      if ((_f = __props.session.safety_warnings) == null ? void 0 : _f.length) {
...
export { session as default };;globalThis.__timing__.logEnd('Load chunks/build/session-BKBrTJsE');
//# sourceMappingURL=session-BKBrTJsE.mjs.map
