...
import { $fetch } from "C:/code/CursorBridge/main-app-starter/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks, createDebugger } from "C:/code/CursorBridge/main-app-starter/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/code/CursorBridge/main-app-starter/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, setCookie, getHeader, getRequestHeader, getCookie, deleteCookie } from "C:/code/CursorBridge/main-app-starter/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "C:/code/CursorBridge/main-app-starter/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "C:/code/CursorBridge/main-app-starter/node_modules/ufo/dist/index.mjs";
import { createServerClient, parseCookieHeader } from "@supabase/ssr";
import { parse } from "C:/code/CursorBridge/main-app-starter/node_modules/cookie-es/dist/index.mjs";
import destr from "C:/code/CursorBridge/main-app-starter/node_modules/destr/dist/index.mjs";
import { isEqual } from "C:/code/CursorBridge/main-app-starter/node_modules/nuxt/node_modules/ohash/dist/index.mjs";
import { klona } from "C:/code/CursorBridge/main-app-starter/node_modules/klona/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Cypi4kPH.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-D-uqV1t7.js")
  },
  {
    name: "session",
    path: "/session",
    component: () => import("./_nuxt/session-BKBrTJsE.js")
  },
  {
    name: "sessions",
    path: "/sessions",
    component: () => import("./_nuxt/sessions-DVIe3zP1.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import("./_nuxt/dashboard-BsLQX4uI.js")
  },
  {
    name: "sessions-composer-prototype",
    path: "/sessions-composer-prototype",
    component: () => import("./_nuxt/sessions-composer-prototype-D7CAlWye.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-D9EsUI2h.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BBZfpSji.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CRxYV1yZ.js"));
